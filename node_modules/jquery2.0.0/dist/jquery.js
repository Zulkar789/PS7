...
(function (e, undefined) {
  ...
  (x.fn = x.prototype =
    ...
    (x.extend = x.fn.extend =
      function () {
        ...
        var l = !1;
        for (
          typeof s == "boolean" && ((l = s), (s = arguments[1] || {}), (a = 2)),
  ...
  (t = x(o)),
    (function (e, undefined) {
      ...
      function lt(e, t) {
        var n = t && e;
        var r = n && (~t.sourceIndex || D) - (~e.sourceIndex || D);
        if (r) return r;
              ...
              CHILD: function (e, t, n, r, i) {
                ...
                return r === 1 && i === 0
                  ...
                  : function (t, n, u) {
                      ...
                      var m = t.parentNode;
                      var v = a && t.nodeName.toLowerCase();
                      var x = !u && !a;
                      if (m) {
                        if (o) {
                          while (g) {
      ...
      function Tt(e, t) {
        ...
        var u = function (u, l, f, p, h) {
          ...
          var T = h != null;
          var C = a;
          var k = u || (s && r.find.TAG("*", (h && l.parentNode) || l));
          var N = (w += C == null ? 1 : Math.random() || 0.1);
  ...
  (x.Callbacks = function (e) {
    ...
    x.extend({
      ...
      when: function (e) {
        ...
        var r = n.length;
        var i = r !== 1 || (e && x.isFunction(e.promise)) ? r : 0;
        var o = i === 1 ? e : x.Deferred();
  ...
  (F.uid = 1),
    ...
    (F.prototype = {
      ...
      access: function (e, t, n) {
        return t === undefined || (t && typeof t == "string" && n === undefined)
          ? this.get(e, t)
  ...
  var Q = { children: !0, contents: !0, next: !0, prev: !0 };
  x.fn.extend({
    find: function (e) {
      var t;
      var n;
    ...
    closest: function (e, t) {
      ...
      var i = this.length;
      var o = [];
      var s = J.test(e) || typeof e != "string" ? x(e, t || this.context) : 0;
      for (; i > r; r++)
    ...
    add: function (e, t) {
      var n =
        typeof e == "string" ? x(e, t) : x.makeArray(e && e.nodeType ? [e] : e);
  ...
  var ot = /checked\s*(?:[^=]|=\s*.checked.)/i;
  var st = /^$|\/(?:java|ecma)script/i;
  var at = /^true\/(.*)/;
  var ut = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
  var lt = {
  ...
  var bt = /^margin/;
  var wt = RegExp("^(" + b + ")(.*)$", "i");
  var Tt = RegExp("^(" + b + ")(?!px)[a-z%]+$", "i");
  var Ct = RegExp("^([+-])=(" + b + ")", "i");
  var kt = { BODY: "block" };
  var Nt = { position: "absolute", visibility: "hidden", display: "block" };
  var Et = { letterSpacing: 0, fontWeight: 400 };
  ...
  var It = /^(?:input|select|textarea|keygen)/i;
  x.fn.extend({
    serialize: function () {
  ...
  (x.fn.load = function (e, t, n) {
    ...
    x.extend({
      ...
      ajax: function (e, t) {
        ...
        var c = x.ajaxSetup({}, t);
        var f = c.context || c;
        var p = c.context && (f.nodeType || f.jquery) ? x(f) : x.event;
        var h = x.Deferred();
  ...
  var vn;
  var xn;
  var bn = /^(?:toggle|show|hide)$/;
  var wn = RegExp("^(?:([+-])=|)(" + b + ")([a-z%]*)$", "i");
  var Tn = /queueHooks$/;
  var Cn = [Dn];
  var kn = {
    "*": [
  ...
  function Sn(e, t, n) {
    ...
    var o = 0;
    var s = Cn.length;
    var a = x.Deferred().always(function () {
      delete u.elem;
    });
    var u = function () {
      if (i) return !1;
  ...
  x.each({ Height: "height", Width: "width" }, function (e, t) {
    x.each(
      ...
      function (n, r) {
        x.fn[r] = function (r, i) {
          var o = arguments.length && (n || typeof r != "boolean");
