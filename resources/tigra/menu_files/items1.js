...
function wrap_blue(text) {
  ...
  for (var i = 0; i < 3; i++)
    res[i] = [
      '<table cellpadding="0" cellspacing="0" border="0"><tr><td><img src="/resources/images/blue',
      i ? 2 : 1,
      '_l.gif" width="8" height="21" border="0"></td><td background="/resources/images/blue',
      i ? 2 : 1,
      '_m.gif" style="font-face: tahoma, verdana, arial; font-size: 11px; text-align:center; font-weight: bold; color: #ffffff" width="100%">',
      text,
      '</td><td><img src="/resources/images/blue',
      i ? 2 : 1,
      '_r.gif" width="8" height="21" border="0"></td></tr></table>',
    ].join("");
  return res;
}
