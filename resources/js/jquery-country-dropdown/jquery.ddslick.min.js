    ...
    if (l.showSelectedHTML) {
      d.html(
        (m.imageSrc
          ...
          : "") +
          (m.text
            ? '<label class="dd-selected-text">' + m.text + "</label>"
            : "") +
          (m.description
            ? '<small class="dd-selected-description dd-desc' +
              (l.truncateDescription
      ...
      if (!f) {
          ...
          m.append(
            "<li>" +
              ...
              (c.imageSrc
                ...
                : "") +
              (c.text
                ? ' <label class="dd-option-text">' + c.text + "</label>"
                : "") +
              (c.description
        ...
        if (b.selectText.length > 0 && b.defaultSelectedIndex == null) {
          ...
          var o =
            ...
            b.defaultSelectedIndex < b.data.length
              ? b.defaultSelectedIndex
              : 0;
          g(c, o);
        }
